...
opt_define short=n long=nice desc="Niceness range from 0 to 19 (least favorable)" variable=NICE default=10
opt_define_pvlng
...
NICE=$(int $NICE)
[ $NICE -lt  0 ] && error_exit "Valid nice level: 0..19"
[ $NICE -gt 19 ] && error_exit "Valid nice level: 0..19"
